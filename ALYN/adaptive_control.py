...
input(10) -> Ensemble -> output (5) -> 
          -> Ensemble ->
          -> Ensemble ->
          -> Ensemble ->
          -> Ensemble ->
    Training signals--^ (u - u_biased): learning the delta
...
class DynamicsAdaptation:
    ...
    def __init__(self,
        n_input,                    # Number of inputs (angles, velocities) [5 positions; 5 velocities]
        ...
        **kwargs
        ...
        with self.nengo_model:
            ...
            for ii in range(self.n_ensembles):
                ...
                # Connect input signal to adaptive population to provide context
                nengo.Connection(
