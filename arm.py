...
class Simulation:
    ...
    def __init__(self, model,                # Instance of the mechanical model of the arm
        ...
        self.null_position = np.zeros(6)
        self.null_position[:3] = self.get_ee_position()
        self.null_position[3:] = euler_from_quaternion(self.get_ee_quaternion())
    ...
    def simulate(self, 
        ...
        for exp in self.monitor_dict:
            ...
            self.simulation.data.set_mocap_pos("target", target[:3])
    ...
    def send_forces(self, u):  
        ...
        self.simulation.data.set_mocap_quat("hand", self.get_ee_quaternion())
